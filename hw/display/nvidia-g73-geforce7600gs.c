/*
 * NVIDIA GeForce 7600 GS (G73, AGP 8x via HSI, 256MB DDR2, 2006)
...
#define GPU_DEVICE_ID  0x0393
#define GPU_SUBSYS_VID 0x10DE
#define GPU_SUBSYS_DID 0x0393
...
#define TYPE_NVIDIA_G73_GEFORCE7600GS "nvidia-g73-geforce7600gs"
OBJECT_DECLARE_SIMPLE_TYPE(NvidiaG73Geforce7600gsState, NVIDIA_G73_GEFORCE7600GS)
struct NvidiaG73Geforce7600gsState {
...
static uint32_t gpu_clk(NvidiaG73Geforce7600gsState *s) {
...
static uint64_t bar0_r(void *opaque, hwaddr addr, unsigned size) {
    NvidiaG73Geforce7600gsState *s = opaque; uint32_t m; uint64_t n;
    switch (addr & ~3ULL) {
...
static void gpu_realize(PCIDevice *p, Error **e) {
    NvidiaG73Geforce7600gsState *s=(NvidiaG73Geforce7600gsState*)p;
    ...
    memory_region_init_io(&s->bar0,OBJECT(s),&b0ops,s,"nvidia-g73-geforce7600gs-mmio",NV_BAR0_SIZE);
    pci_register_bar(p,0,PCI_BASE_ADDRESS_SPACE_MEMORY|PCI_BASE_ADDRESS_MEM_TYPE_32,&s->bar0);
    memory_region_init_io(&s->bar1,OBJECT(s),&b135ops,s,"nvidia-g73-geforce7600gs-vram",NV_BAR1_SIZE);
...
static const Property gpu_props_nvidia_g73_geforce7600gs[]={DEFINE_PROP_UINT32("gpu-count",NvidiaG73Geforce7600gsState,gpu_count,1),
    ...
    DEFINE_PROP_STRING("board-partner",NvidiaG73Geforce7600gsState,board_partner)};
static const VMStateDescription vms_nvidia_g73_geforce7600gs={.name="nvidia-g73-geforce7600gs",.version_id=1,.minimum_version_id=1,.fields=(const VMStateField[]){VMSTATE_PCI_DEVICE(parent_obj,NvidiaG73Geforce7600gsState),VMSTATE_UINT32(intr_en,NvidiaG73Geforce7600gsState),VMSTATE_UINT32(clock_mhz,NvidiaG73Geforce7600gsState),VMSTATE_UINT64(clock_last_ns,NvidiaG73Geforce7600gsState),
        VMSTATE_UINT32(gpu_count,NvidiaG73Geforce7600gsState),VMSTATE_END_OF_LIST()}};
static void ci(ObjectClass *k, const void *d) {
    DeviceClass *dc=DEVICE_CLASS(k); PCIDeviceClass *pc=PCI_DEVICE_CLASS(k);
    pc->realize=gpu_realize; pc->vendor_id=GPU_VENDOR_ID; pc->device_id=0x0393;
    pc->class_id=GPU_CLASS; pc->revision=GPU_REVISION;
    dc->desc="NVIDIA GeForce 7600 GS (G73, AGP 8x via HSI, 256MB DDR2, 2006)"; dc->vmsd=&vms_nvidia_g73_geforce7600gs; dc->hotpluggable=false;
    device_class_set_props(dc,gpu_props_nvidia_g73_geforce7600gs);
    set_bit(DEVICE_CATEGORY_DISPLAY,dc->categories);
}
static const TypeInfo ti_nvidia_g73_geforce7600gs={.name=TYPE_NVIDIA_G73_GEFORCE7600GS,.parent=TYPE_PCI_DEVICE,.instance_size=sizeof(NvidiaG73Geforce7600gsState),.class_init=ci,.interfaces=(InterfaceInfo[]){{INTERFACE_CONVENTIONAL_PCI_DEVICE},{}}};
static void reg_nvidia_g73_geforce7600gs(void){type_register_static(&ti_nvidia_g73_geforce7600gs);}
type_init(reg_nvidia_g73_geforce7600gs)
