...
struct AmdRadeon780mState { PCIDevice parent_obj; MemoryRegion bar0,bar1; uint32_t clock_mhz; uint64_t clock_last_ns; char *gpu_name; };
...
static const Property props[]={DEFINE_PROP_STRING("gpu-name",AmdRadeon780mState,gpu_name),};
