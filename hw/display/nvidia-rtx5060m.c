...
struct NvidiaRtx5060mState { PCIDevice parent_obj; MemoryRegion bar0,bar1; uint32_t clock_mhz; uint64_t clock_last_ns; char *gpu_name;     char *board_partner;
};
...
static const Property props[]={DEFINE_PROP_STRING("gpu-name",NvidiaRtx5060mState,gpu_name),    DEFINE_PROP_STRING("board-partner", NvidiaRtx5060mState, board_partner),
};
