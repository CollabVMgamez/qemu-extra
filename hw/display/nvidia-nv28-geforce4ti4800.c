/*
 * NVIDIA GeForce4 Ti 4800 (NV28, AGP 8x, 128MB DDR, 2002)
...
#define GPU_DEVICE_ID  0x0280
#define GPU_SUBSYS_VID 0x10DE
#define GPU_SUBSYS_DID 0x0280
...
#define TYPE_NVIDIA_NV28_GEFORCE4TI4800 "nvidia-nv28-geforce4ti4800"
OBJECT_DECLARE_SIMPLE_TYPE(NvidiaNv28Geforce4ti4800State, NVIDIA_NV28_GEFORCE4TI4800)
struct NvidiaNv28Geforce4ti4800State {
...
static uint32_t gpu_clk(NvidiaNv28Geforce4ti4800State *s) {
...
static uint64_t bar0_r(void *opaque, hwaddr addr, unsigned size) {
    NvidiaNv28Geforce4ti4800State *s = opaque; uint32_t m; uint64_t n;
    switch (addr & ~3ULL) {
...
static void gpu_realize(PCIDevice *p, Error **e) {
    NvidiaNv28Geforce4ti4800State *s=(NvidiaNv28Geforce4ti4800State*)p;
    ...
    memory_region_init_io(&s->bar0,OBJECT(s),&b0ops,s,"nvidia-nv28-geforce4ti4800-mmio",NV_BAR0_SIZE);
    pci_register_bar(p,0,PCI_BASE_ADDRESS_SPACE_MEMORY|PCI_BASE_ADDRESS_MEM_TYPE_32,&s->bar0);
    memory_region_init_io(&s->bar1,OBJECT(s),&b135ops,s,"nvidia-nv28-geforce4ti4800-vram",NV_BAR1_SIZE);
...
static const Property gpu_props_nvidia_nv28_geforce4ti4800[]={DEFINE_PROP_UINT32("gpu-count",NvidiaNv28Geforce4ti4800State,gpu_count,1),
    DEFINE_PROP_STRING("board-partner",NvidiaNv28Geforce4ti4800State,board_partner)};
static const VMStateDescription vms_nvidia_nv28_geforce4ti4800={.name="nvidia-nv28-geforce4ti4800",.version_id=1,.minimum_version_id=1,.fields=(const VMStateField[]){VMSTATE_PCI_DEVICE(parent_obj,NvidiaNv28Geforce4ti4800State),VMSTATE_UINT32(intr_en,NvidiaNv28Geforce4ti4800State),VMSTATE_UINT32(clock_mhz,NvidiaNv28Geforce4ti4800State),VMSTATE_UINT64(clock_last_ns,NvidiaNv28Geforce4ti4800State),
        VMSTATE_UINT32(gpu_count,NvidiaNv28Geforce4ti4800State),VMSTATE_END_OF_LIST()}};
static void ci(ObjectClass *k, const void *d) {
    DeviceClass *dc=DEVICE_CLASS(k); PCIDeviceClass *pc=PCI_DEVICE_CLASS(k);
    pc->realize=gpu_realize; pc->vendor_id=GPU_VENDOR_ID; pc->device_id=0x0280;
    pc->class_id=GPU_CLASS; pc->revision=GPU_REVISION;
    dc->desc="NVIDIA GeForce4 Ti 4800 (NV28, AGP 8x, 128MB DDR, 2002)"; dc->vmsd=&vms_nvidia_nv28_geforce4ti4800; dc->hotpluggable=false;
    device_class_set_props(dc,gpu_props_nvidia_nv28_geforce4ti4800);
    set_bit(DEVICE_CATEGORY_DISPLAY,dc->categories);
}
static const TypeInfo ti_nvidia_nv28_geforce4ti4800={.name=TYPE_NVIDIA_NV28_GEFORCE4TI4800,.parent=TYPE_PCI_DEVICE,.instance_size=sizeof(NvidiaNv28Geforce4ti4800State),.class_init=ci,.interfaces=(InterfaceInfo[]){{INTERFACE_CONVENTIONAL_PCI_DEVICE},{}}};
static void reg_nvidia_nv28_geforce4ti4800(void){type_register_static(&ti_nvidia_nv28_geforce4ti4800);}
type_init(reg_nvidia_nv28_geforce4ti4800)
