/*
 * NVIDIA GeForce2 GTS (NV15, AGP 4x, 64MB DDR, 2000)
...
#define GPU_DEVICE_ID  0x0150
#define GPU_SUBSYS_VID 0x10DE
#define GPU_SUBSYS_DID 0x0150
#define GPU_REVISION   0x00
#define GPU_CLASS      0x0300
#define GPU_MEM_MHZ    200
...
#define GPU_CLK_BASE    200
#define GPU_CLK_BOOST   200
#define AGP_CAP_OFFSET  0x40

#define TYPE_NVIDIA_NV15_GEFORCE2GTS "nvidia-nv15-geforce2gts"
OBJECT_DECLARE_SIMPLE_TYPE(NvidiaNv15Geforce2gtsState, NVIDIA_NV15_GEFORCE2GTS)
struct NvidiaNv15Geforce2gtsState {
...
static uint32_t gpu_clk(NvidiaNv15Geforce2gtsState *s) {
...
static uint64_t bar0_r(void *opaque, hwaddr addr, unsigned size) {
    NvidiaNv15Geforce2gtsState *s = opaque; uint32_t m; uint64_t n;
    switch (addr & ~3ULL) {
...
static void gpu_realize(PCIDevice *p, Error **e) {
    NvidiaNv15Geforce2gtsState *s=(NvidiaNv15Geforce2gtsState*)p;
    ...
    memory_region_init_io(&s->bar0,OBJECT(s),&b0ops,s,"nvidia-nv15-geforce2gts-mmio",NV_BAR0_SIZE);
    pci_register_bar(p,0,PCI_BASE_ADDRESS_SPACE_MEMORY|PCI_BASE_ADDRESS_MEM_TYPE_32,&s->bar0);
    memory_region_init_io(&s->bar1,OBJECT(s),&b135ops,s,"nvidia-nv15-geforce2gts-vram",NV_BAR1_SIZE);
    pci_register_bar(p,1,PCI_BASE_ADDRESS_SPACE_MEMORY|PCI_BASE_ADDRESS_MEM_TYPE_32|PCI_BASE_ADDRESS_MEM_PREFETCH,&s->bar1);
    memory_region_init_io(&s->bar3,OBJECT(s),&b135ops,s,"nvidia-nv15-geforce2gts-ramin",NV_BAR3_SIZE);
    pci_register_bar(p,3,PCI_BASE_ADDRESS_SPACE_MEMORY|PCI_BASE_ADDRESS_MEM_TYPE_32,&s->bar3);
    memory_region_init_io(&s->bar5,OBJECT(s),&b135ops,s,"nvidia-nv15-geforce2gts-vgaio",NV_BAR5_SIZE);
...
static const Property gpu_props_nvidia_nv15_geforce2gts[]={DEFINE_PROP_UINT32("gpu-count",NvidiaNv15Geforce2gtsState,gpu_count,1),
    DEFINE_PROP_STRING("gpu-name",NvidiaNv15Geforce2gtsState,gpu_name),
    DEFINE_PROP_STRING("board-partner",NvidiaNv15Geforce2gtsState,board_partner)};
static const VMStateDescription vms_nvidia_nv15_geforce2gts={.name="nvidia-nv15-geforce2gts",.version_id=1,.minimum_version_id=1,.fields=(const VMStateField[]){VMSTATE_PCI_DEVICE(parent_obj,NvidiaNv15Geforce2gtsState),VMSTATE_UINT32(intr_en,NvidiaNv15Geforce2gtsState),VMSTATE_UINT32(clock_mhz,NvidiaNv15Geforce2gtsState),VMSTATE_UINT64(clock_last_ns,NvidiaNv15Geforce2gtsState),
        VMSTATE_UINT32(gpu_count,NvidiaNv15Geforce2gtsState),VMSTATE_END_OF_LIST()}};
static void ci(ObjectClass *k, const void *d) {
    DeviceClass *dc=DEVICE_CLASS(k); PCIDeviceClass *pc=PCI_DEVICE_CLASS(k);
    pc->realize=gpu_realize; pc->vendor_id=GPU_VENDOR_ID; pc->device_id=0x0150;
    pc->class_id=GPU_CLASS; pc->revision=GPU_REVISION;
    dc->desc="NVIDIA GeForce2 GTS (NV15, AGP 4x, 64MB DDR, 2000)"; dc->vmsd=&vms_nvidia_nv15_geforce2gts; dc->hotpluggable=false;
    device_class_set_props(dc,gpu_props_nvidia_nv15_geforce2gts);
    set_bit(DEVICE_CATEGORY_DISPLAY,dc->categories);
}
static const TypeInfo ti_nvidia_nv15_geforce2gts={.name=TYPE_NVIDIA_NV15_GEFORCE2GTS,.parent=TYPE_PCI_DEVICE,.instance_size=sizeof(NvidiaNv15Geforce2gtsState),.class_init=ci,.interfaces=(InterfaceInfo[]){{INTERFACE_CONVENTIONAL_PCI_DEVICE},{}}};
static void reg_nvidia_nv15_geforce2gts(void){type_register_static(&ti_nvidia_nv15_geforce2gts);}
type_init(reg_nvidia_nv15_geforce2gts)
