...
static void gpu_realize(PCIDevice *p, Error **e) {
    NvidiaGtx1660tiState *s=(NvidiaGtx1660tiState*)p; s->gpu_count=1;
...
static const Property gpu_multi_props_NvidiaGtx1660tiState[] = {
    DEFINE_PROP_STRING("gpu-name", NvidiaGtx1660tiState, gpu_name),
    DEFINE_PROP_UINT32("gpu-count", NvidiaGtx1660tiState, gpu_count, 1),
    DEFINE_PROP_STRING("board-partner", NvidiaGtx1660tiState, board_partner),
};
static void ci(ObjectClass *k, const void *d) {
    ...
    dc->desc="NVIDIA GeForce GTX 1660 Ti (TU116, Turing)"; dc->vmsd=&vms_nvidia_gtx1660ti; dc->hotpluggable=false; device_class_set_props(dc,gpu_multi_props_NvidiaGtx1660tiState);
