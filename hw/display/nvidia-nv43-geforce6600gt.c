/*
 * NVIDIA GeForce 6600 GT (NV43, AGP 8x, 128MB GDDR3, 2004)
...
#define GPU_DEVICE_ID  0x0141
#define GPU_SUBSYS_VID 0x10DE
#define GPU_SUBSYS_DID 0x0141
...
#define TYPE_NVIDIA_NV43_GEFORCE6600GT "nvidia-nv43-geforce6600gt"
OBJECT_DECLARE_SIMPLE_TYPE(NvidiaNv43Geforce6600gtState, NVIDIA_NV43_GEFORCE6600GT)
struct NvidiaNv43Geforce6600gtState {
...
static uint32_t gpu_clk(NvidiaNv43Geforce6600gtState *s) {
...
static uint64_t bar0_r(void *opaque, hwaddr addr, unsigned size) {
    NvidiaNv43Geforce6600gtState *s = opaque; uint32_t m; uint64_t n;
    switch (addr & ~3ULL) {
...
static void gpu_realize(PCIDevice *p, Error **e) {
    NvidiaNv43Geforce6600gtState *s=(NvidiaNv43Geforce6600gtState*)p;
    ...
    memory_region_init_io(&s->bar0,OBJECT(s),&b0ops,s,"nvidia-nv43-geforce6600gt-mmio",NV_BAR0_SIZE);
    pci_register_bar(p,0,PCI_BASE_ADDRESS_SPACE_MEMORY|PCI_BASE_ADDRESS_MEM_TYPE_32,&s->bar0);
    memory_region_init_io(&s->bar1,OBJECT(s),&b135ops,s,"nvidia-nv43-geforce6600gt-vram",NV_BAR1_SIZE);
    pci_register_bar(p,1,PCI_BASE_ADDRESS_SPACE_MEMORY|PCI_BASE_ADDRESS_MEM_TYPE_32|PCI_BASE_ADDRESS_MEM_PREFETCH,&s->bar1);
    memory_region_init_io(&s->bar3,OBJECT(s),&b135ops,s,"nvidia-nv43-geforce6600gt-ramin",NV_BAR3_SIZE);
    pci_register_bar(p,3,PCI_BASE_ADDRESS_SPACE_MEMORY|PCI_BASE_ADDRESS_MEM_TYPE_32,&s->bar3);
    memory_region_init_io(&s->bar5,OBJECT(s),&b135ops,s,"nvidia-nv43-geforce6600gt-vgaio",NV_BAR5_SIZE);
    pci_register_bar(p,5,PCI_BASE_ADDRESS_SPACE_MEMORY,&s->bar5);
}
static const Property gpu_props_nvidia_nv43_geforce6600gt[]={DEFINE_PROP_UINT32("gpu-count",NvidiaNv43Geforce6600gtState,gpu_count,1),
    DEFINE_PROP_STRING("gpu-name",NvidiaNv43Geforce6600gtState,gpu_name),
    DEFINE_PROP_STRING("board-partner",NvidiaNv43Geforce6600gtState,board_partner)};
static const VMStateDescription vms_nvidia_nv43_geforce6600gt={.name="nvidia-nv43-geforce6600gt",.version_id=1,.minimum_version_id=1,.fields=(const VMStateField[]){VMSTATE_PCI_DEVICE(parent_obj,NvidiaNv43Geforce6600gtState),VMSTATE_UINT32(intr_en,NvidiaNv43Geforce6600gtState),VMSTATE_UINT32(clock_mhz,NvidiaNv43Geforce6600gtState),VMSTATE_UINT64(clock_last_ns,NvidiaNv43Geforce6600gtState),
        VMSTATE_UINT32(gpu_count,NvidiaNv43Geforce6600gtState),VMSTATE_END_OF_LIST()}};
static void ci(ObjectClass *k, const void *d) {
    DeviceClass *dc=DEVICE_CLASS(k); PCIDeviceClass *pc=PCI_DEVICE_CLASS(k);
    pc->realize=gpu_realize; pc->vendor_id=GPU_VENDOR_ID; pc->device_id=0x0141;
    pc->class_id=GPU_CLASS; pc->revision=GPU_REVISION;
    dc->desc="NVIDIA GeForce 6600 GT (NV43, AGP 8x, 128MB GDDR3, 2004)"; dc->vmsd=&vms_nvidia_nv43_geforce6600gt; dc->hotpluggable=false;
    device_class_set_props(dc,gpu_props_nvidia_nv43_geforce6600gt);
    set_bit(DEVICE_CATEGORY_DISPLAY,dc->categories);
}
static const TypeInfo ti_nvidia_nv43_geforce6600gt={.name=TYPE_NVIDIA_NV43_GEFORCE6600GT,.parent=TYPE_PCI_DEVICE,.instance_size=sizeof(NvidiaNv43Geforce6600gtState),.class_init=ci,.interfaces=(InterfaceInfo[]){{INTERFACE_CONVENTIONAL_PCI_DEVICE},{}}};
static void reg_nvidia_nv43_geforce6600gt(void){type_register_static(&ti_nvidia_nv43_geforce6600gt);}
type_init(reg_nvidia_nv43_geforce6600gt)
