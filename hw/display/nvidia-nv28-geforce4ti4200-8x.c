/*
 * NVIDIA GeForce4 Ti 4200 AGP 8x (NV28, AGP 8x, 128MB, 2002)
...
#define GPU_DEVICE_ID  0x0281
#define GPU_SUBSYS_VID 0x10DE
#define GPU_SUBSYS_DID 0x0281
#define GPU_REVISION   0x00
#define GPU_CLASS      0x0300
#define GPU_MEM_MHZ    250
...
#define GPU_CLK_BASE    250
#define GPU_CLK_BOOST   250
#define AGP_CAP_OFFSET  0x40

#define TYPE_NVIDIA_NV28_GEFORCE4TI4200_8X "nvidia-nv28-geforce4ti4200-8x"
OBJECT_DECLARE_SIMPLE_TYPE(NvidiaNv28Geforce4ti42008xState, NVIDIA_NV28_GEFORCE4TI4200_8X)
struct NvidiaNv28Geforce4ti42008xState {
...
static uint32_t gpu_clk(NvidiaNv28Geforce4ti42008xState *s) {
...
static uint64_t bar0_r(void *opaque, hwaddr addr, unsigned size) {
    NvidiaNv28Geforce4ti42008xState *s = opaque; uint32_t m; uint64_t n;
    switch (addr & ~3ULL) {
...
static void gpu_realize(PCIDevice *p, Error **e) {
    NvidiaNv28Geforce4ti42008xState *s=(NvidiaNv28Geforce4ti42008xState*)p;
    ...
    memory_region_init_io(&s->bar0,OBJECT(s),&b0ops,s,"nvidia-nv28-geforce4ti4200-8x-mmio",NV_BAR0_SIZE);
    pci_register_bar(p,0,PCI_BASE_ADDRESS_SPACE_MEMORY|PCI_BASE_ADDRESS_MEM_TYPE_32,&s->bar0);
    memory_region_init_io(&s->bar1,OBJECT(s),&b135ops,s,"nvidia-nv28-geforce4ti4200-8x-vram",NV_BAR1_SIZE);
    pci_register_bar(p,1,PCI_BASE_ADDRESS_SPACE_MEMORY|PCI_BASE_ADDRESS_MEM_TYPE_32|PCI_BASE_ADDRESS_MEM_PREFETCH,&s->bar1);
    memory_region_init_io(&s->bar3,OBJECT(s),&b135ops,s,"nvidia-nv28-geforce4ti4200-8x-ramin",NV_BAR3_SIZE);
    pci_register_bar(p,3,PCI_BASE_ADDRESS_SPACE_MEMORY|PCI_BASE_ADDRESS_MEM_TYPE_32,&s->bar3);
    memory_region_init_io(&s->bar5,OBJECT(s),&b135ops,s,"nvidia-nv28-geforce4ti4200-8x-vgaio",NV_BAR5_SIZE);
...
static const Property gpu_props_nvidia_nv28_geforce4ti4200_8x[]={DEFINE_PROP_UINT32("gpu-count",NvidiaNv28Geforce4ti42008xState,gpu_count,1),
    DEFINE_PROP_STRING("gpu-name",NvidiaNv28Geforce4ti42008xState,gpu_name),
    DEFINE_PROP_STRING("board-partner",NvidiaNv28Geforce4ti42008xState,board_partner)};
static const VMStateDescription vms_nvidia_nv28_geforce4ti4200_8x={.name="nvidia-nv28-geforce4ti4200-8x",.version_id=1,.minimum_version_id=1,.fields=(const VMStateField[]){VMSTATE_PCI_DEVICE(parent_obj,NvidiaNv28Geforce4ti42008xState),VMSTATE_UINT32(intr_en,NvidiaNv28Geforce4ti42008xState),VMSTATE_UINT32(clock_mhz,NvidiaNv28Geforce4ti42008xState),VMSTATE_UINT64(clock_last_ns,NvidiaNv28Geforce4ti42008xState),
        VMSTATE_UINT32(gpu_count,NvidiaNv28Geforce4ti42008xState),VMSTATE_END_OF_LIST()}};
static void ci(ObjectClass *k, const void *d) {
    DeviceClass *dc=DEVICE_CLASS(k); PCIDeviceClass *pc=PCI_DEVICE_CLASS(k);
    pc->realize=gpu_realize; pc->vendor_id=GPU_VENDOR_ID; pc->device_id=0x0281;
    pc->class_id=GPU_CLASS; pc->revision=GPU_REVISION;
    dc->desc="NVIDIA GeForce4 Ti 4200 AGP 8x (NV28, AGP 8x, 128MB, 2002)"; dc->vmsd=&vms_nvidia_nv28_geforce4ti4200_8x; dc->hotpluggable=false;
    device_class_set_props(dc,gpu_props_nvidia_nv28_geforce4ti4200_8x);
    set_bit(DEVICE_CATEGORY_DISPLAY,dc->categories);
}
static const TypeInfo ti_nvidia_nv28_geforce4ti4200_8x={.name=TYPE_NVIDIA_NV28_GEFORCE4TI4200_8X,.parent=TYPE_PCI_DEVICE,.instance_size=sizeof(NvidiaNv28Geforce4ti42008xState),.class_init=ci,.interfaces=(InterfaceInfo[]){{INTERFACE_CONVENTIONAL_PCI_DEVICE},{}}};
static void reg_nvidia_nv28_geforce4ti4200_8x(void){type_register_static(&ti_nvidia_nv28_geforce4ti4200_8x);}
type_init(reg_nvidia_nv28_geforce4ti4200_8x)
