...
static const Property gpu_multi_props_AmdRadeonR9390xState[] = {
    DEFINE_PROP_STRING("gpu-name", AmdRadeonR9390xState, gpu_name),
    DEFINE_PROP_UINT32("gpu-count", AmdRadeonR9390xState, gpu_count, 1),
    DEFINE_PROP_STRING("board-partner", AmdRadeonR9390xState, board_partner),
};
static void ci(ObjectClass *k, const void *d) {
    ...
    dc->desc="AMD Radeon R9 390X (Hawaii, PCIe x16, 8GB GDDR5, 2015)"; dc->vmsd=&vms_amd_radeon_r9_390x; dc->hotpluggable=false; device_class_set_props(dc,gpu_multi_props_AmdRadeonR9390xState);
