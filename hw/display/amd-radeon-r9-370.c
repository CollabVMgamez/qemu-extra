...
static const Property gpu_multi_props_AmdRadeonR9370State[] = {
    DEFINE_PROP_STRING("gpu-name", AmdRadeonR9370State, gpu_name),
    DEFINE_PROP_UINT32("gpu-count", AmdRadeonR9370State, gpu_count, 1),
    DEFINE_PROP_STRING("board-partner", AmdRadeonR9370State, board_partner),
};
