...
static const Property gpu_multi_props_AmdRx460State[] = {
    DEFINE_PROP_STRING("gpu-name", AmdRx460State, gpu_name),
    DEFINE_PROP_UINT32("gpu-count", AmdRx460State, gpu_count, 1),
    DEFINE_PROP_STRING("board-partner", AmdRx460State, board_partner),
};
static void ci(ObjectClass *k, const void *d) {
    ...
    dc->desc="AMD Radeon RX 460 (Polaris11, GCN 4.0)"; dc->vmsd=&vms_amd_rx460; dc->hotpluggable=false; device_class_set_props(dc,gpu_multi_props_AmdRx460State);
