/*
 * NVIDIA GeForce4 MX 440-8x SE (NV18, AGP 8x, 64MB, 2002)
...
#define GPU_DEVICE_ID  0x0181
#define GPU_SUBSYS_VID 0x10DE
#define GPU_SUBSYS_DID 0x0181
...
#define TYPE_NVIDIA_NV18_GEFORCE4MX440SE "nvidia-nv18-geforce4mx440se"
OBJECT_DECLARE_SIMPLE_TYPE(NvidiaNv18Geforce4mx440seState, NVIDIA_NV18_GEFORCE4MX440SE)
struct NvidiaNv18Geforce4mx440seState {
...
static uint32_t gpu_clk(NvidiaNv18Geforce4mx440seState *s) {
...
static uint64_t bar0_r(void *opaque, hwaddr addr, unsigned size) {
    NvidiaNv18Geforce4mx440seState *s = opaque; uint32_t m; uint64_t n;
    switch (addr & ~3ULL) {
...
static void gpu_realize(PCIDevice *p, Error **e) {
    NvidiaNv18Geforce4mx440seState *s=(NvidiaNv18Geforce4mx440seState*)p;
    ...
    memory_region_init_io(&s->bar0,OBJECT(s),&b0ops,s,"nvidia-nv18-geforce4mx440se-mmio",NV_BAR0_SIZE);
    pci_register_bar(p,0,PCI_BASE_ADDRESS_SPACE_MEMORY|PCI_BASE_ADDRESS_MEM_TYPE_32,&s->bar0);
    memory_region_init_io(&s->bar1,OBJECT(s),&b135ops,s,"nvidia-nv18-geforce4mx440se-vram",NV_BAR1_SIZE);
    pci_register_bar(p,1,PCI_BASE_ADDRESS_SPACE_MEMORY|PCI_BASE_ADDRESS_MEM_TYPE_32|PCI_BASE_ADDRESS_MEM_PREFETCH,&s->bar1);
    memory_region_init_io(&s->bar3,OBJECT(s),&b135ops,s,"nvidia-nv18-geforce4mx440se-ramin",NV_BAR3_SIZE);
    pci_register_bar(p,3,PCI_BASE_ADDRESS_SPACE_MEMORY|PCI_BASE_ADDRESS_MEM_TYPE_32,&s->bar3);
    memory_region_init_io(&s->bar5,OBJECT(s),&b135ops,s,"nvidia-nv18-geforce4mx440se-vgaio",NV_BAR5_SIZE);
...
static const Property gpu_props_nvidia_nv18_geforce4mx440se[]={DEFINE_PROP_UINT32("gpu-count",NvidiaNv18Geforce4mx440seState,gpu_count,1),
    DEFINE_PROP_STRING("gpu-name",NvidiaNv18Geforce4mx440seState,gpu_name),
    DEFINE_PROP_STRING("board-partner",NvidiaNv18Geforce4mx440seState,board_partner)};
static const VMStateDescription vms_nvidia_nv18_geforce4mx440se={.name="nvidia-nv18-geforce4mx440se",.version_id=1,.minimum_version_id=1,.fields=(const VMStateField[]){VMSTATE_PCI_DEVICE(parent_obj,NvidiaNv18Geforce4mx440seState),VMSTATE_UINT32(intr_en,NvidiaNv18Geforce4mx440seState),VMSTATE_UINT32(clock_mhz,NvidiaNv18Geforce4mx440seState),VMSTATE_UINT64(clock_last_ns,NvidiaNv18Geforce4mx440seState),
        VMSTATE_UINT32(gpu_count,NvidiaNv18Geforce4mx440seState),VMSTATE_END_OF_LIST()}};
static void ci(ObjectClass *k, const void *d) {
    DeviceClass *dc=DEVICE_CLASS(k); PCIDeviceClass *pc=PCI_DEVICE_CLASS(k);
    pc->realize=gpu_realize; pc->vendor_id=GPU_VENDOR_ID; pc->device_id=0x0181;
    pc->class_id=GPU_CLASS; pc->revision=GPU_REVISION;
    dc->desc="NVIDIA GeForce4 MX 440-8x SE (NV18, AGP 8x, 64MB, 2002)"; dc->vmsd=&vms_nvidia_nv18_geforce4mx440se; dc->hotpluggable=false;
    device_class_set_props(dc,gpu_props_nvidia_nv18_geforce4mx440se);
    set_bit(DEVICE_CATEGORY_DISPLAY,dc->categories);
}
static const TypeInfo ti_nvidia_nv18_geforce4mx440se={.name=TYPE_NVIDIA_NV18_GEFORCE4MX440SE,.parent=TYPE_PCI_DEVICE,.instance_size=sizeof(NvidiaNv18Geforce4mx440seState),.class_init=ci,.interfaces=(InterfaceInfo[]){{INTERFACE_CONVENTIONAL_PCI_DEVICE},{}}};
static void reg_nvidia_nv18_geforce4mx440se(void){type_register_static(&ti_nvidia_nv18_geforce4mx440se);}
type_init(reg_nvidia_nv18_geforce4mx440se)
